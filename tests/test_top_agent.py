...
# from mage.self_rag_adapter import SelfRAGRetriever, SelfRAGAgent  # NEW
# from mage.benchmark_read_helper import (
#     TypeBenchmark,
#     TypeBenchmarkFile,
#     get_benchmark_contents,
...
# RAG_INDEX_PATH = "data/rtlcoder.index"  # NEW
...
#     agent = SelfRAGAgent(retriever=retriever, llm=llm)
#     # ------------------------------------------
